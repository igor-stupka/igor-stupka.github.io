...
navigator.connection.addEventListener('change', offLineNotification()); // expand body height

if (document.body.offsetHeight < window.innerHeight) document.body.classList.add('full-height');